...
export type UiEventHandlers = {
  ...
  exportOpml: () => void;
  exportJsonCanvas: () => void;
  exportSvg: () => void;
  exportPng: () => void;
  openSnapshotPanel: () => void;
  importMap: (event: Event) => void;
  importMarkdown: (event: Event) => void;
  importOpml: (event: Event) => void;
  importJsonCanvas: (event: Event) => void;
  toggleSidebar: () => void;
  ...
  onAttachmentSubmit: (event: SubmitEvent) => void;
  renderRelationshipPreviews: () => void;
  onReviewModeChange: () => void;
  ...
  openReviewNote: () => void;
  fixCurrentReviewItem: () => void;
  closeCommandPalette: () => void;
  onCommandPaletteInput: () => void;
  onCommandPaletteKeydown: (event: KeyboardEvent) => void;
  createSnapshot: () => void;
  closeSnapshotPanel: () => void;
...
export function bindUiEvents(els: AppElements, handlers: UiEventHandlers): void {
  ...
  els.reviewButton.addEventListener("click", handlers.openReview);
  ...
  els.markdownFolderExportButton.addEventListener("click", handlers.exportMarkdownFolder);
  els.opmlExportButton.addEventListener("click", handlers.exportOpml);
  els.jsonCanvasExportButton.addEventListener("click", handlers.exportJsonCanvas);
  els.svgExportButton.addEventListener("click", handlers.exportSvg);
  els.pngExportButton.addEventListener("click", handlers.exportPng);
  els.snapshotButton.addEventListener("click", handlers.openSnapshotPanel);
  els.importInput.addEventListener("change", handlers.importMap);
  els.markdownImportInput.addEventListener("change", handlers.importMarkdown);
  els.opmlImportInput.addEventListener("change", handlers.importOpml);
  els.jsonCanvasImportInput.addEventListener("change", handlers.importJsonCanvas);
  ...
  els.detailsTabSources.addEventListener("click", handlers.showSourcesTab);
  ...
  els.attachmentForm.addEventListener("submit", handlers.onAttachmentSubmit);
  ...
  els.reviewModeInput.addEventListener("change", handlers.onReviewModeChange);
  ...
  els.reviewOpenNoteButton.addEventListener("click", handlers.openReviewNote);
  els.reviewFixButton.addEventListener("click", handlers.fixCurrentReviewItem);
  els.commandPaletteCloseButton.addEventListener("click", handlers.closeCommandPalette);
  els.commandPaletteInput.addEventListener("input", handlers.onCommandPaletteInput);
  els.commandPaletteInput.addEventListener("keydown", handlers.onCommandPaletteKeydown);
  els.createSnapshotButton.addEventListener("click", handlers.createSnapshot);
  els.snapshotCloseButton.addEventListener("click", handlers.closeSnapshotPanel);
